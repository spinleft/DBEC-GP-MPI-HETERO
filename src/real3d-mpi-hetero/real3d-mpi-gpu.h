...
extern cuDoubleComplex Ax0r, Ay0r, Az0r, Ax, Ay, Az;
extern cuDoubleComplex *calphax, *calphay, *calphaz;
extern cuDoubleComplex *cgammax, *cgammay, *cgammaz;
extern cuDoubleComplex ***psi, ***psi_t;
...
struct gpux_t {
   ...
   cuDoubleComplex *calphay, *calphaz, *cgammay, *cgammaz;
...
struct gpuy_t {
   ...
   cuDoubleComplex *calphax, *cgammax;
