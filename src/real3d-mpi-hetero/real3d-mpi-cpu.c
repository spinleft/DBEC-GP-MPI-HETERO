...
int main(int argc, char **argv) {
   ...
   pin_complex_tensor(psi_t, Nx, localNy, Nz);
...
#ifdef FFTW_TRAN
   plan_tr_psi_x = fftw_mpi_plan_many_transpose(Nx, Ny * Nz, 2, localNx, localNy * Nz, (double *) **psi, (double *) **psi_t, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_OUT);
   plan_tr_psi_y = fftw_mpi_plan_many_transpose(Ny * Nz, Nx, 2, localNy * Nz, localNx, (double *) **psi_t, (double *) **psi, MPI_COMM_WORLD, FFT_FLAG | FFTW_MPI_TRANSPOSED_IN);
...
#else
   tran_psi = init_transpose_complex(nprocs, localNx, localNy, Ny, Nz, **psi, Nz * sizeof(double complex), **psi_t, Nz * sizeof(double complex));
 ...
 */
void calcmuen(double *mu, double *en, double complex ***psi, double complex ***psi_t, double ***dpsi, double ***dpsi_t, double ***psidd2, fftw_complex *psidd2fft, fftw_complex *psidd2fft_t, double **tmpxi, double **tmpyi, double **tmpzi, double **tmpxj, double **tmpyj, double **tmpzj) {
   int threadid;
   long cnti, cntj, cntk;
 ...
 *    psidd2fft_t - array with the transposed squared wave function fft values
 */
/*void calcpsidd2(double complex ***psi, double ***psidd2, fftw_complex *psidd2fft, fftw_complex *psidd2fft_t) {
   long cnti, cntj, cntk;
   double tmp;
   int ismax = 0;
...
void calcpsidd2_cpu_p1(double complex***psi, double ***psidd2, fftw_complex *psidd2fft) {
   long cnti, cntj, cntk;
   double tmp;
 ...
 *    pot    - array with the potential
 */
/*void calcnu(double complex ***psi, double ***psidd2, double ***pot) {
   long cnti, cntj, cntk;
...
void calcnu_cpu(double complex ***psi, double ***psidd2, double ***pot) {
   long cnti, cntj, cntk;
   double psi2, psi2lin, psidd2lin, tmp;
...
void calclux_cpu(double complex ***psi, double complex **cbeta) {
   int threadid;
   long cnti, cntj, cntk;
   double complex c;
...
void calcluy_cpu(double complex ***psi, double complex **cbeta) {
   int threadid;
   long cnti, cntj, cntk;
   double complex c;
...
void calcluz_cpu(double complex ***psi, double complex **cbeta) {
   int threadid;
   long cnti, cntj, cntk;
   double complex c;
...
void calcpsi_o1(double complex ***psi, double complex ***psi_t, double ***psidd2, double ***pot, double complex **cbeta) {
...
void calcpsi_o2(double complex ***psi, double complex ***psi_t, double ***psidd2, double ***pot, double complex **cbeta) {
...
void calcpsi_o3(double complex ***psi, double complex ***psi_t, double ***psidd2, double ***pot, double complex **cbeta) {
...
void calcnuluy(double complex ***psi, double ***psidd2, double ***pot, double complex **cbeta) {
   int threadid;
...
void calcnuluyluz(double complex ***psi, double ***psidd2, double ***pot, double complex **cbeta) {
   int threadid;
